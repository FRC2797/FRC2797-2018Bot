...
public class Drivetrain extends Subsystem implements PIDOutput{
    ...
    public Drivetrain() {
		leftPID = new PIDController(0.0075, 0.0, 0.0, 0.0, leftEnc, this);
		...
		rightPID = new PIDController(0.0075, 0.0, 0.0, 0.0, rightEnc, this);
		rightPID.setAbsoluteTolerance(1.0);
		...
		gyroPID = new PIDController(0.03, 0.0, 0.0, navX, this);
