...
public class RobotMap {
    ...
    public static DoubleSolenoid clawarm;
    ...
    public static void init() {
        ...
        clawarm = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("Claw", "arm", clawarm);
