...
public class RobotMap {
	...
	public static Solenoid clawArmOpen;
	public static Solenoid clawArmLift;
	...
	public static void init() {
		...
		elevatorelevatorEnc = new Encoder(6, 7, true, EncodingType.k2X);
		LiveWindow.addSensor("Elevator", "elevatorEnc", elevatorelevatorEnc);
		elevatorelevatorEnc.setDistancePerPulse(1.0);
		elevatorelevatorEnc.setPIDSourceType(PIDSourceType.kDisplacement);
		...
		clawArmOpen = new Solenoid(0, 3);
		LiveWindow.addActuator("Claw", "ArmOpen", clawArmOpen);

		clawArmLift = new Solenoid(0, 2);
		LiveWindow.addActuator("Claw", "ArmLift", clawArmLift);
